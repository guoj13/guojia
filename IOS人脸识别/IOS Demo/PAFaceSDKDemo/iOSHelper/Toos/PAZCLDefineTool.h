...
#define kFaceImage(name)   [UIImage imageNamed:[NSString stringWithFormat:@"PAFaceSDKSource.bundle/%@", name]]
...
#define kScaleHeight(height)   (kIphone4?(height):((height)*kScreenHeight)/667)    //高度按比例适配
